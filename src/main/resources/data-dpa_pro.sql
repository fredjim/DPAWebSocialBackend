...
insert into institution (id, uuid, name, description, location, category, email, phone, url, logo_url, background_url) values
	(10, '93j203b4-f63b-4c4a-be05-eae84cef0c0c',
        unistr('DPA - Direcci\00F3n de Planificaci\00F3n Académica'),
...
insert into article (id, uuid, section_id, user_id, title, text, date) values
...
insert into article_media (id, uuid, article_id, file_name, number, file_type, file_path) values
	(100, 'e7629149-79db-4bc6-85c9-12fa52d35c34', '819ab4e8-0856-4aad-b3aa-747e2dba76d9', 'img01', 1, 'image', 'http://dpa.umss.net/api/v1/images/posts/e7629149-79db-4bc6-85c9-12fa52d35c34'),
    (101, 'a5a0a99c-6280-4b74-a507-12a5a2109cd5', '846ib4e8-0856-4aad-b3aa-747e2dba76d9', 'img01', 1, 'image', 'http://dpa.umss.net/api/v1/images/posts/a5a0a99c-6280-4b74-a507-12a5a2109cd5');
